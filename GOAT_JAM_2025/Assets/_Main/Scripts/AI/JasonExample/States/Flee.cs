...
namespace Scripts.AI.JasonExample.States
{
    public class Flee : IState
    {
        ...
        private readonly EnemyDetector2 _enemyDetector;
        ...
        public Flee(Gatherer gatherer, NavMeshAgent navMeshAgent, EnemyDetector2 enemyDetector, Animator animator, ParticleSystem particleSystem)
        {
            _gatherer = gatherer;
